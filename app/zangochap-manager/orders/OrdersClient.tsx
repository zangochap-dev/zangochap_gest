                ...
                <div key={item.id} style={{ background: 'white', padding: 10, borderRadius: 10, border: '1px solid var(--line-2)', position: 'relative', display: 'flex', gap: 10, boxShadow: 'var(--shadow-sm)' }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', gap: 4, marginTop: 4 }}>
                      <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--brown-soft)', background: 'var(--cream)', padding: '1px 6px', borderRadius: 4 }}>{item.size}</span>
                      <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--brown-soft)', background: 'var(--cream)', padding: '1px 6px', borderRadius: 4 }}>{item.color}</span>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 8 }}>
                      <div style={{ fontSize: 12, fontWeight: 800, color: 'var(--orange)', fontFamily: 'var(--font-display)' }}>{formatPrice(item.price)}</div>
                      <div style={{ display: 'flex', alignItems: 'center', background: 'var(--cream)', borderRadius: 6, padding: 2, border: '1px solid var(--line)' }}>
                        ...
                        <span style={{ fontSize: 11, fontWeight: 800, width: 24, textAlign: 'center', color: 'var(--ink)' }}>{item.qty}</span>
