...
import { TableCard, DetailCard, SectionLabel } from "@/components/UI";
import { useToast } from "@/components/Toast";
import { createProduct } from "@/modules/products/actions";
import { formatPrice, CATEGORIES } from "@/lib/constants";
import { useRouter } from "next/navigation";
import { Plus, X, Upload, Check, Image as ImageIcon, Box, Tag, Info, LayoutGrid, Sparkles, RefreshCcw, Save } from "lucide-react";
...
export default function NewProductPage() {
  ...
  // -- States matching HTML Structure --
    ...
    <div style={{ background: '#F8F5F2', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="content animate-fade-in" style={{ flex: 1, padding: '24px', maxWidth: '1000px', margin: '0 auto', width: '100%' }}>
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          {/* 4. VARIANTES */}
          <TableCard 
            title="4. Variantes : quantité & emplacement" 
          ...
          {/* 5. PUBLICATION */}
          <TableCard title="5. Statut de publication">
            <div style={{ padding: 20 }}>
              <label 
                style={{ 
                  display: 'flex', 
