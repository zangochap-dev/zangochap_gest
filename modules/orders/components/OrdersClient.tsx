...
Ne passez pas à côté de cette belle surprise ! 😍🔥`;
    ...
    startTransition(async () => {
      ...
      await addOrderHistoryEntry(order.id, `Récapitulatif WhatsApp envoyé par ${user?.name}`);
  ...
  const handlePrintReceipt = useCallback((order: any, format: 'a4' | 'a6' | 'thermal') => {
    ...
    const dateStr = new Date(order.createdAt).toLocaleString('fr-FR', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' });
    ...
    const typeStyle = order.type ? getTypeStyle(order.type) : { bg: '', text: '' };
    ...
    if (!win) {
      ...
      showToast('Le navigateur a bloqué la fenêtre. Autorise les pop-ups.', 'error');
  ...
  const handleDownloadPDF = useCallback((order: any) => {
    ...
    (window as any).html2pdf().from(container).set(opt).save().then(() => {
      ...
      startTransition(async () => {
        ...
        await addOrderHistoryEntry(order.id, `PDF du reçu téléchargé (par ${user?.name})`);
                  ...
                  return (
                    ...
                    <tr key={order.id}>
                      ...
                      <td>
                        ...
                        <div style={{ fontWeight: 600, color: order.status === 'REPROGRAMMED' ? 'var(--orange)' : 'var(--ink)' }}>
                      ...
                      <td>
                        ...
                        {order.status === 'ON_DELIVERY' && order.deliverymanName && (
                          ...
                          <div style={{ fontSize: 10, color: 'var(--brown-soft)', marginTop: 4, justifyContent: 'center', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
...
const TypeBadge = ({ type, compact = false }: { type: string; compact?: boolean }) => {
  ...
  const color = colors[type] || { bg: 'var(--orange-soft)', text: 'var(--orange)' };
              ...
              <>
                ...
                {canEdit && order.status !== 'CANCELLED' && (
                  ...
                  <>
                    ...
                    {['CONFIRMED', 'PACKED'].includes(order.status) && (
                      ...
                      <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                        ...
                        <select
                          ...
                          style={{ padding: '0 10px', height: 38, fontSize: 12 }}
                          ...
                          onChange={(e) => {
                            ...
                            if (val) {
                              ...
                              if (confirm(`Attribuer cette commande à ${deliverymen?.find(d => d.id === val)?.name} ?`)) {
                    ...
                    <button className="btn-secondary" onClick={() => onStatusChange(order.id, 'CANCELLED')} disabled={isPending} style={{ borderColor: 'var(--amber)', color: 'var(--amber)' }}>
                ...
                <button className="btn-secondary" onClick={() => onPrintReceipt(order)} style={{ background: '#fef3c7', color: '#b45309', borderColor: '#fcd34d' }}>
                ...
                <button className="btn-secondary" onClick={() => setIsReprogramming(true)} style={{ background: 'var(--orange-soft)', color: 'var(--orange)', borderColor: 'var(--orange-soft)' }}>
      ...
      >
        ...
        {isReprogramming ? (
          ...
          <div style={{ padding: 20, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 13, color: 'var(--brown-soft)', marginBottom: 24 }}>Choisissez la nouvelle date de livraison prévue pour cette commande.</p>
            ...
            <div className="form-row" style={{ maxWidth: 300, margin: '0 auto' }}>
              ...
              <label className="field-label-sm">NOUVELLE DATE DE LIVRAISON</label>
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 32 }}>
              ...
              <button className="btn-orange" onClick={() => onReprogram(order.id, reprogramDate)} disabled={isPending}>
          ...
          <div className="order-detail-grid">
            ...
            <div style={{ gridColumn: '1 / -1', marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10, position: 'relative' }}>
                ...
                {['PENDING', 'CONFIRMED', 'PACKED', 'ON_DELIVERY', 'DELIVERED'].map((s, i, arr) => {
                  ...
                  return (
                    ...
                    <div key={s} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, position: 'relative', zIndex: 1 }}>
                      ...
                      <div style={{
                        ...
                        color: isCompleted || isCurrent ? 'white' : 'var(--brown-soft)',
                        ...
                        {isCompleted ? <Check size={14} strokeWidth={3} /> : <span style={{ fontSize: 10, fontWeight: 800 }}>{i + 1}</span>}
                      ...
                      <span style={{
                        ...
                        color: isCancelled ? '#EF4444' : (isCurrent ? 'var(--orange)' : 'var(--brown-soft)'),
                ...
                {isEditing ? (
                  ...
                  <div className="form-grid" style={{ gap: 10 }}>
                    ...
                    <div className="form-row">
                      ...
                      <input type="number" className="field-input-sm" value={editData.deliveryFee} onChange={e => setEditData({ ...editData, deliveryFee: parseInt(e.target.value) || 0 })} />
                    ...
                    <div className="form-row" style={{ gridColumn: '1 / -1' }}>
                      ...
                      <textarea className="field-input-sm" value={editData.customerLocation} onChange={e => setEditData({ ...editData, customerLocation: e.target.value })} style={{ minHeight: 60 }} />
              ...
              <div style={{ marginTop: 14 }}>
                ...
                <DetailCard label="Articles commandés">
                  ...
                  {order.items.map((item: any, i: number) => {
                    ...
                    const fallbackImg = products.find(p => p.id === item.productId)?.images?.[0]?.url;
              ...
              <div style={{ marginTop: 14 }}>
                ...
                <DetailCard>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                    ...
                    <span>Sous-total</span><span className="cell-price">{formatPrice(order.total)}</span>
                  ...
                  {order.discount > 0 && (
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6, color: 'var(--green)' }}>
                      ...
                      <span>Remise {order.promoCode && `(${order.promoCode})`}</span><span>-{formatPrice(order.discount)}</span>
                  ...
                  <div style={{ borderTop: '1px solid var(--line)', paddingTop: 8, display: 'flex', justifyContent: 'space-between', fontWeight: 700, fontSize: 16 }}>
                    ...
                    <span>Total</span><span className="cell-price">{formatPrice((order.total || 0) + (order.deliveryFee || 0) - (order.discount || 0))}</span>
            ...
            <div>
              ...
              <DetailCard label="Statut">
                ...
                <div className="cell-muted" style={{ marginTop: 6, fontSize: 11 }}>
                ...
                <DetailCard label="Intervenants">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 4 }}>
                    ...
                    <StaffRow
                      ...
                      phone={findPhone(order.commercialName, order.commercialId)}
                    ...
                    <StaffRow
                      ...
                      phone={collectors.length === 1 ? findPhone(collectors[0]) : null}
                ...
                <div style={{ marginTop: 14 }}>
                  ...
                  <DetailCard label="Notes internes">
                    ...
                    {isEditing ? (
                      ...
                      <textarea className="field-input-sm" value={editData.notes} onChange={e => setEditData({ ...editData, notes: e.target.value })} placeholder="Notes internes (non visibles par le client)..." style={{ minHeight: 80 }} />
              ...
              {isEditing && (
                ...
                <div style={{ marginTop: 14 }}>
                  ...
                  <DetailCard label="Note de livraison">
                    ...
                    <textarea className="field-input-sm" value={editData.deliveryNote} onChange={e => setEditData({ ...editData, deliveryNote: e.target.value })} placeholder="Instructions pour le livreur..." />
...
function StaffRow({ label, value, phone, icon }: { label: string; value?: string | null; phone?: string | null; icon: React.ReactNode }) {
  ...
  return (
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <div style={{ width: 24, height: 24, borderRadius: 6, background: 'var(--cream-2)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--brown-soft)' }}>
      ...
      <div>
        ...
        <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--ink)' }}>
          ...
          {phone && <span style={{ marginLeft: 8, color: 'var(--orange)', fontSize: 11, fontWeight: 700 }}>{phone}</span>}
...
function OrderFormModal({ order, mode = 'duplicate', onClose, onConfirm, isPending, onPreviewImage, products = [] }: { order: any; mode?: 'duplicate' | 'edit'; onClose: () => void; onConfirm: (data: any) => void; isPending: boolean; onPreviewImage: (url: string | null) => void; products?: any[] }) {
  ...
  const { data: cartProductsData } = useQuery({
    ...
    queryFn: async () => {
      ...
      const res = await fetch(`/api/products/search?ids=${cartProductIds.join(',')}&allStatus=true`);
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr 340px', gap: 0, height: '70vh', position: 'relative', margin: '-24px' }}>
        ...
        <div style={{ background: 'white', padding: 24, borderRight: '1px solid var(--line)', overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 24 }}>
            ...
            <label style={{ fontSize: 11, fontWeight: 800, color: 'var(--brown-soft)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Destinataire & Logistique</label>
          ...
          <div className="form-grid full" style={{ gap: 20 }}>
            ...
            <div className="form-row">
              ...
              <label className="field-label-sm" style={{ marginBottom: 8 }}>TYPE DE TRANSACTION</label>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                ...
                {['Standard', 'Echange', 'Express', 'Recuperation', 'Reprogrammé'].map(t => {
                  ...
                  const colors = typeColors[t] || { bg: 'var(--cream)', text: 'var(--brown-soft)' };
                  ...
                  return (
                    ...
                    <button
                      ...
                      style={{
                        ...
                        padding: '10px 8px', fontSize: 11, fontWeight: 700, borderRadius: 8,
            ...
            {formData.type === 'Echange' && (
              ...
              <div className="form-row" style={{ animation: 'fadeIn 0.3s' }}>
                ...
                <label className="field-label-sm" style={{ color: 'var(--orange)' }}>MOTIF DE L'ÉCHANGE</label>
            ...
            <div className="form-row">
              ...
              <label className="field-label-sm" style={{ color: 'var(--orange)', fontWeight: 700 }}>DATE DE LIVRAISON</label>
              ...
              <input
                ...
                style={{ border: '1.5px solid var(--orange-soft)', borderRadius: 8, fontWeight: 700 }}
          ...
          <div style={{ position: 'relative' }}>
            ...
            {productSearch && (
              ...
              <button
                ...
                style={{ position: 'absolute', right: 16, top: '50%', transform: 'translateY(-50%)', border: 'none', background: 'transparent', cursor: 'pointer', color: 'var(--brown-soft)' }}
        ...
        <div style={{ background: 'var(--cream-2)', padding: 20, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 16 }}>
            ...
            <label style={{ fontSize: 10, fontWeight: 800, color: 'var(--brown)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Panier</label>
          ...
          <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 10, paddingRight: 4 }}>
            ...
            {formData.items.length === 0 ? (
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'white', borderRadius: 12, border: '1px dashed var(--line-2)', padding: 32, textAlign: 'center' }}>
                ...
                <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--ink)' }}>Panier vide</div>
              ...
              formData.items.map((item: any) => (
                ...
                <div key={item.id} style={{ background: 'white', padding: 10, borderRadius: 10, border: '1px solid var(--line-2)', position: 'relative', display: 'flex', gap: 10, boxShadow: 'var(--shadow-sm)' }}>
                  ...
                  <div style={{ width: 48, height: 48, borderRadius: 8, background: 'var(--cream)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, border: '1px solid var(--line)' }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', gap: 4, marginTop: 4, alignItems: 'center' }}>
                      ...
                      {(() => {
                        ...
                        const productObj = products?.find((p: any) => p.id === item.productId) 
                          ...
                          || cartProductsDetails?.find((p: any) => p.id === item.productId);
                        ...
                        return item.productId && productObj?.variants?.length > 0 ? (
                          ...
                          <>
                            ...
                            <select
                              ...
                              onChange={(e) => {
                                ...
                                const matchingVariant = productObj.variants.find(
                                  ...
                                  (v: any) => v.size === newSize && v.color === item.color
                            ...
                            >
                              ...
                              {Array.from(new Set(productObj.variants.map((v: any) => v.size))).map((size: any) => (
                            ...
                            <select
                              ...
                              onChange={(e) => {
                                ...
                                ) || productObj.variants.find((v: any) => v.color === newColor);
                            ...
                            >
                              ...
                              {Array.from(new Set(productObj.variants.filter((v: any) => v.size === item.size).map((v: any) => v.color))).map((color: any) => (
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setFormData((prev: any) => ({
                                      ...
                                      items: prev.items.map((it: any) => it.id === item.id ? { ...it, size: val } : it)
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setFormData((prev: any) => ({
                                      ...
                                      items: prev.items.map((it: any) => it.id === item.id ? { ...it, color: val } : it)
                      ...
                      {(!item.productId || !(products?.find((p: any) => p.id === item.productId) || catalogProducts?.find((p: any) => p.id === item.productId) || cartProductsDetails?.find((p: any) => p.id === item.productId))?.variants?.length) && !item.isCustom && (
                        ...
                        <span style={{ fontSize: 9, fontWeight: 700, color: 'var(--brown-soft)', background: 'var(--cream)', padding: '1px 6px', borderRadius: 4 }}>{item.color || 'Standard'}</span>
                      ...
                      {getVariantStock(item.productId, item.size, item.color) <= 0 && (
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 8 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                          ...
                          <input
                            ...
                            style={{
                              ...
                              textDecoration: item.isGift ? 'line-through' : 'none'
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', background: 'var(--cream)', borderRadius: 6, padding: 2, border: '1px solid var(--line)' }}>
                        ...
                        <button onClick={() => updateItemQty(item.id, 1)} style={{ width: 22, height: 22, borderRadius: 4, background: 'white', border: '1px solid var(--line)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--ink)' }}><Plus size={12} /></button>
                  ...
                  <button
                    ...
                    style={{ position: 'absolute', top: -6, right: -6, width: 22, height: 22, borderRadius: '50%', background: 'var(--ink)', color: 'white', border: '2px solid white', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: 'var(--shadow-md)' }}
          ...
          <div style={{ marginTop: 24, padding: 24, background: 'var(--ink)', borderRadius: 12, color: 'white', boxShadow: 'var(--shadow-lg)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12, borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: 12 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Total des articles</div>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                ...
                <button
                  ...
                  style={{ height: 'fit-content', background: 'var(--red)', color: 'white', border: 'none', borderRadius: 8, padding: '6px 12px', fontSize: 10, fontWeight: 800, cursor: 'pointer', textTransform: 'uppercase' }}
            ...
            <label style={{ fontSize: 11, fontWeight: 800, color: 'var(--orange-soft)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 8, display: 'block' }}>Montant net à encaisser</label>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{
                  ...
                  height: 64, borderRadius: 10, padding: '0 20px', fontFamily: 'var(--font-display)', width: '100%', outline: 'none'
