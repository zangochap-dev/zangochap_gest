...
export default function NewProductClient({ warehouses, categories, suppliers = [], commercials = [], user }: { warehouses: any[], categories: any[], suppliers?: any[], commercials?: any[], user?: any }) {
